...
export const hairService = {
    reasonTitle: "Vì sao cần phải chăm sóc tóc thường xuyên?",
    reasonContent:
        "Cuộc sống ngày càng bận rộn và môi trường ngày càng ô nhiễm là nguyên nhân khiến mái tóc dễ bị tổn thương. Căng thẳng thường xuyên có thể khiến cơ thể bị rối loạn nội tiết, gây tóc mỏng và xơ rối. Ngoài ra, bụi và vi khuẩn bám lên tóc cũng khiến tóc dễ bị gãy rụng. Do đó, bạn cần chú ý đến những bước chăm sóc tóc cơ bản như gội đầu, dưỡng ẩm và che chắn mái tóc khi ở ngoài trời. Chăm sóc tóc không chỉ giới hạn ở những biện pháp bảo vệ tóc, mà còn mở rộng ra việc làm đẹp cho tóc. Đừng quên cắt tỉa tóc thường xuyên, hấp dầu định kỳ và chăm sóc tóc nhuộm đúng cách. Nhờ những biện pháp này, mái tóc không chỉ khỏe mạnh mà còn đẹp, giúp ngũ quan của bạn trở nên hài hòa và ngoại hình cuốn hút hơn.",
    overAll:
        "Trong thời gian gần đây, có một xu hướng ngày càng tăng về việc quan tâm đến chăm sóc mái tóc, không chỉ từ phía các bạn trẻ mà cả những người trung niên. Nguyên nhân của xu hướng này là do chất lượng cuộc sống được cải thiện, dẫn đến nhu cầu làm đẹp và chăm sóc bản thân tăng cao. Để đáp ứng tốt nhất nhu cầu của khách hàng, Gentle Beauty   đã phát triển các dịch vụ chuyên nghiệp và toàn diện về chăm sóc tóc.",
    ...
    serviceList: [
        {
            ...
            image: images?.hair_design_service,
        },
        {
            id: 2,
            title: "Uốn tóc",
            partArticle1:
                "Tóc uốn luôn dẫn đầu xu hướng thời trang trong nhiều năm qua. Nếu muốn trải nghiệm việc uốn tóc hoặc muốn đổi kiểu tóc uốn khác, hãy đến với Gentle Beauty  . Những chuyên gia tại Gentle Beauty luôn cập nhật xu hướng mới nhất sẽ tư vấn giúp bạn chọn được kiểu tóc uốn độc đáo và phù hợp nhất với cá tính của mình.",
            partArticle2:
...
export const nailService = {
    overAll:
        "Trong thời gian gần đây, sự quan tâm đến dịch vụ làm nail ngày càng tăng cao, không chỉ từ phía các bạn trẻ mà cả những người trung niên. Nguyên nhân của xu hướng này là do cải thiện chất lượng cuộc sống, tạo ra nhu cầu làm đẹp và chăm sóc bản thân ngày càng lớn. Với mục tiêu đáp ứng tốt nhất nhu cầu của khách hàng, Gentle Beauty   tự hào mang đến các dịch vụ làm nail chuyên nghiệp và toàn diện, giúp khách hàng có được sự chăm sóc tốt nhất cho móng tay của mình.",
    title: "Gentle Beauty đang cung cấp những dịch vụ nails nào?",
    description:
        "Hiểu được nhu cầu làm đẹp của khách hàng, Gentle Beauty đã và đang phát triển những dịch vụ nails chuyên nghiệp và toàn diện nhất. Những dịch vụ thu hút nhiều sự quan tâm của khách hàng nhất phải kể đến là:",
    serviceList: [
        {
            id: 1,
        ...
        {
            id: 2,
            title: "Dịch vụ sơn, vẽ móng tay chân.",
            partArticle1:
                "Khách đến tiệm nail không chỉ muốn được vệ sinh sạch sẽ móng tay chân mà họ còn mong muốn biến chúng thành các tác phẩm nghệ thuật độc đáo. Với kỹ thuật sơn, vẽ khéo léo, tỉ mỉ tạo ra nhiều mẫu đẹp mắt, tinh tế chúng tôi sẽ giúp bạn “trang điểm” cho bộ móng tay, chân của bạn. Bạn sẽ bị ngạc nhiên và không nhận ra bộ móng tay, chân vốn đơn điệu ngày nào trở nên xinh đẹp, thu hút lạ thường.",
        ...
        },
        {
            ...
            title: "Ẩn xà cừ",
            partArticle1:
                "Trong những năm gần đây dịch vụ nail này bỗng lên ngôi. Với phương pháp này chúng tôi sẽ dùng xà cừ cẩn lên móng tay chân theo các hình dáng đẹp mắt, thu hút. Xà cừ phụ kiện được sử dụng khá phổ biến và rộng rãi trong trang trí móng. Đá xà cừ có nhiều loại to nhỏ khác nhau, trong đó có xà cừ giấy, xà cừ đá. Chỉ cần một chút sáng tạo chúng tôi sẽ tạo nên các tác phẩm nghệ thuật trên bộ móng của khách hàng.",
            image: images?.anNhuXaCu,
        },
        {
            id: 5,
