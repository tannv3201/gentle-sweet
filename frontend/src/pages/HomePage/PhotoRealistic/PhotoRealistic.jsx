...
const photoList = [
    {
        title: "Nails",
        images: [
            { src: images.nailDraw1 },
            { src: images.nailDraw2 },
            { src: images.nailDraw3 },
            { src: images.nailDraw4 },
            { src: images.nailDraw5 },
        ],
    },
    {
        title: "Hair",
        images: [
            { src: images.hairStyle1 },
            { src: images.hairStyle2 },
            { src: images.hairStyle3 },
            { src: images.hairStyle4 },
            { src: images.hairStyle5 },
        ],
    },
];
